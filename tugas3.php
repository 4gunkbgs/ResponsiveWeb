...
<body>
        ...
        <div class="row">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark col">
                ...
                <div class="navbar-nav mr-auto">
                    <div class="navbar-brand">
                        <h2>Tugas 3</h2>
                        <h2>Menghitung Deret Fibonacci & Baris Aritmatika</h2>
                    </div>
                </div>
            </nav>
        </div>
    ...
    <div class="container container-margin height-container">
        <div class="row justify-content-center mb-5">
            <div class="col-lg-6">
                <a href="fibonacci.php" class="btn btn-dark btn-lg btn-block box-container">Deret Fibonacci</a>
            </div>
        </div>
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-lg-6">
                <a href="aritmatika.php" class="btn btn-dark btn-block btn-lg box-container">Baris Aritmatika</a>
            </div>
        </div>
    </div>
    <!-- Akhir Container -->
